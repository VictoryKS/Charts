defmodule Statistic.TimeScale do
  alias __MODULE__
  ...
  """
  @spec new :: Statistic.TimeScale.t()
  def new() do
  ...
  Default is 10.
  """
  @spec interval_count(Statistic.TimeScale.t(), integer()) :: Statistic.TimeScale.t()
  ...
  """
  @spec domain(Statistic.TimeScale.t(), datetimes(), datetimes()) :: Statistic.TimeScale.t()
  ...
  """
  @spec domain(Statistic.TimeScale.t(), list(datetimes())) :: Statistic.TimeScale.t()
  ...
  defimpl Statistic.Scale do
    ...
    defp format_tick_text(tick, _display_format, _), do: ts_format(tick.day) <> "." <> ts_format(tick.month) <> "." <> "#{tick.year}"
    defp ts_format(x), do: x < 10 && "0#{x}" || "#{x}"
  end
end